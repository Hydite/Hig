...
pub use recovery::{
    RecoveryAtRestPolicy, RecoveryAuditActor, RecoveryAuditEvent, RecoveryAuditOperation,
    RecoveryAuditOutcome, RecoveryAuditReport, RecoveryAuthCustodyReport,
    RecoveryAuthMigrationReport, RecoveryAuthRotationReport, RecoveryCaptureReport,
    RecoveryDurability, RecoveryGcCandidate, RecoveryPinReport, RecoveryPoint, RecoveryPointState,
    RecoveryPromotionReport, RecoveryRegistration, RecoveryRegistrationReport,
    ...
    RecoveryVaultListReport, RecoveryVaultStatusReport, RecoveryVerifyReport,
    capture_recovery_point, default_recovery_vault_root, export_recovery_auth_custody,
    gc_recovery_vault, import_recovery_auth_custody, init_recovery_vault, list_recovery_vault,
    migrate_recovery_auth, promote_recovery_vault, record_recovery_tombstone, recovery_audit_log,
    recovery_vault_config, recovery_vault_status, register_recovery_repository,
    repair_recovery_point, restore_recovery_point, rotate_recovery_auth_key, scrub_recovery_vault,
    set_recovery_point_pin, update_recovery_retention, verify_recovery_point,
};
pub use repository::{
