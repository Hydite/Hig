...
pub use recovery::{
    ...
    RecoveryAuthMigrationReport, RecoveryCaptureReport, RecoveryDurability, RecoveryGcCandidate,
    RecoveryPinReport, RecoveryPoint, RecoveryPointState, RecoveryPromotionReport,
    RecoveryRegistration, RecoveryRegistrationReport, RecoveryRepairReport, RecoveryReplicaStatus,
    ...
    default_recovery_vault_root, export_recovery_auth_custody, gc_recovery_vault,
